...
contract RUBICGANG is Context, IERC20, Ownable {
    ...
    string private _name = "Moby Dick";
    ...
    address payable public charityAddress = 0xA1Da7848Fb2FAbE892f23B85AE7863543058185d; // Charity Address
